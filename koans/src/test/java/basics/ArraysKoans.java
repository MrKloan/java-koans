...
class ArraysKoans {
    ...
    @Koan
    void arrays_do_not_consider_elements_when_evaluating_equality() { /* PASSED */
        assertThat(new int[]{1}.equals(new int[]{1})).isEqualTo(false);
    }

    @Koan
    void thus_a_clone_of_an_array_is_not_equal_to_its_original() { /* PASSED */
    ...
    @Koan
    void arrays_hash_code_does_not_consider_elements() { /* PASSED */
    ...
    @Koan
    void arrays_helper_class_equals_method_considers_elements_when_determining_equality() { /* PASSED */
        int[] firstArray = new int[]{0};
        int[] secondArray = new int[]{0};
    ...
    @Koan
    void arrays_helper_class_hash_code_method_considers_elements_when_determining_hashcode() { /* PASSED */
        int[] firstArray = new int[]{0};
        int[] secondArray = new int[]{0};
    ...
    @Koan
    void arrays_are_indexed_at_0() { /* PASSED */
    ...
    @Koan
    void arrays_can_throw_an_out_of_bound_exception() { /* PASSED */
    ...
    @Koan
    void arrays_are_mutable() { /* PASSED */
    ...
    @Koan
    void array_length_can_be_checked() { /* PASSED */
        assertThat(new int[1].length).isEqualTo(1);
    }

    @Koan
    void use_the_arrays_to_string_helper_method_to_print_the_content_of_an_array() { /* PASSED */
