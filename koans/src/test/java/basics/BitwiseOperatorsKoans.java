...
class BitwiseOperatorsKoans {
    ...
    void bit_shifting_left() {
        ...
        leftShift = leftShift << 1; // nice signed overflow
    ...
    void bit_shifting_right_unsigned() {
        ...
        assertThat(rightShiftNegativeStaysNegative).isEqualTo(-0x8000000);

        int unsignedRightShift = 0x80000000;
        unsignedRightShift >>>= 4;
        assertThat(unsignedRightShift).isEqualTo(0x8000000);
    }
}
